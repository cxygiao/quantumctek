...
from Utils.Tools import dateframe_to_qasm
from Utils.Tools.dateframe_to_qasm import dateframe_to_qasm_fun
    ...
    for line in iter_f:  # 一行行遍历
        if count >= base_line:
            ...
            if line[0:2] == 'CX' or line[0:2] == 'cx':
                ...
                cnot_control = cnot[0]
                cnot_target = cnot[1]
                df_ori_qc.loc[count-base_line] = ['CX', cnot_control, cnot_target]
            else:
            #     # print(line.index(' '))
...
if __name__ == '__main__':
    input_filename = r'E:\python\quantumctek\qasm\color_qasm\2z5\2z5fj_opt.qasm'
    ...
    dateframe_to_qasm_fun(df_ori_qc)